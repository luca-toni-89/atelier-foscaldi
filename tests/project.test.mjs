...
const worker=await readFile('src/worker.ts','utf8'),sql=await readFile('migrations/0001_initial.sql','utf8'),app=await readFile('public/app.js','utf8'),admin=await readFile('public/admin.js','utf8');
