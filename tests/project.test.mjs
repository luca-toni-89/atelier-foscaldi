...
test('homepage includes a random artwork showcase with calm crossfades',()=>{assert.match(app,/shuffled\(artworks/);assert.match(app,/slice\(0,5\)/);assert.match(app,/showcase-slide/);assert.match(app,/5200/);assert.match(style,/showcase-slide\.is-active/)});
